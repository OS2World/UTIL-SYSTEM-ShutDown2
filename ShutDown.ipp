...
:h1 res=&ID_HELP..SD/2 Help for Help
:lines align=center.
:color fc=red.
...
:ul compact.
:li.:link reftype=hd res=&ID_ABOUT..About the utility SD/2:elink.
:li.:link reftype=hd res=&ID_CONFIG..SD/2 Configuration Menu:elink.
:eul.
:p.:link reftype=hd res=&ID_HELP..<Backward>:elink.
                                :link reftype=hd res=&ID_ABOUT..<Forward>:elink.
...
:h1 res=&ID_ABOUT..Help for About SD/2
:lines align=center.
:color fc=red.
SD/2 - ShutDown/2 Version 1.01
for IBM OS/2 2.x Presentation Manager
...
in the :link reftype=hd res=&ID_CONFIG..<Setup dialog>:elink. you have to ensure
...
:p.:link reftype=hd res=&ID_HELP..<Backward>:elink.
                                :link reftype=hd res=&ID_CONFIG..<Forward>:elink.
...
:h1 res=&ID_CONFIG..Help for SD/2 Setup
:p.
...
:ewarning.
:p.:link reftype=hd res=&ID_ABOUT..<Backward>:elink.
